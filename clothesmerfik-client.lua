...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('Colocar Novamente as Roupas'), value = 'ubie'})
	table.insert(elements, {label = ('Remover T-Shirt'), value = 'tul'})
	table.insert(elements, {label = ('Remover Calças'), value = 'spo'})
	table.insert(elements, {label = ('Remover Calçado'), value = 'but'})
	table.insert(elements, {label = ('Fechar Menu'), value = 'close'})
